 ...
 */
final class Version20230122143255 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE livre (id INT AUTO_INCREMENT NOT NULL, genre_id INT NOT NULL, titre VARCHAR(255) NOT NULL, resume VARCHAR(255) NOT NULL, auteur VARCHAR(255) NOT NULL, votes INT NOT NULL, date_ajout DATETIME NOT NULL, date_parution DATETIME NOT NULL, INDEX IDX_AC634F994296D31F (genre_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
